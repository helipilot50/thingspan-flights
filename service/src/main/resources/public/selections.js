...
function prepareItems() {
  ...
  _.each(data, function (call) {
    var direction = call[3];

    if (direction !== 3)  {   // 3 - missed call - ignore these
      var from, to;
      ...
      //Note the data arriving from the server is UTC epoch ms: in this demo
      //the user sees the datetimes in their local time zone of their browser
      var dt = new Date(call[0]);
